...
try {
    ...
    & $mkcert -install
    & $mkcert "*.nextjs_docker.localhost"
...
Add-HostsEntry "cm.nextjs_docker.localhost"
if ($Topology -ne "xp0") {
  Add-HostsEntry "cd.nextjs_docker.localhost"
}
Add-HostsEntry "id.nextjs_docker.localhost"
Add-HostsEntry "www.nextjs_docker.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.nextjs_docker.localhost"

    if ($Topology -ne "xp0") {
      # CD_HOST
      Set-EnvFileVariable "CD_HOST" -Value "cd.nextjs_docker.localhost"
    }

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.nextjs_docker.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.nextjs_docker.localhost"
