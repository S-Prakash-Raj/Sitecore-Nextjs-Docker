...
if ($ByPass) {
  dotnet sitecore login --cm https://cm.nextjs_docker.localhost/ --auth https://id.nextjs_docker.localhost/ --allow-write true --client-id "SitecoreCLIServer" --client-secret "testsecret" --client-credentials true
}else {
  dotnet sitecore login --cm https://cm.nextjs_docker.localhost/ --auth https://id.nextjs_docker.localhost/ --allow-write true
}
...
Start-Process https://cm.nextjs_docker.localhost/sitecore/
Start-Process https://www.nextjs_docker.localhost/
